...
<body>
    <a href="${pageContext.request.contextPath}/admin/author/add">Add more author</a>
    <table border="1">
        <tr>
        ...
        <c:forEach items="${categoryList}" var="cate" varStatus="STT">
            <tr class="odd gradeX">
                ...
                <td style="text-align: center;" width="200">
                    <a href="<c:url value='/admin/author/edit?id=${cate.categoryId }'/>" class="center">Edit</a>
                    <a href="<c:url value='/admin/author/delete?id=${cate.categoryId }'/>" class="center">Delete</a>
                </td>
            </tr>
        </c:forEach>
    </table>

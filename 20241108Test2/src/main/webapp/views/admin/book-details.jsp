    ...
    <div class="container my-4">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4 text-center">
                <img src="${book.coverImage}" alt="${book.title} Cover Image" class="img-fluid"
            ...
            <div class="col-md-8">
                ...
                <p><strong>Authors:</strong>
                    <c:forEach items="${book.authors}" var="author">
                        ${author.authorName}<c:if
                            test="${!author.equals(book.authors[book.authors.size() - 1])}">, </c:if>
                    </c:forEach>
                </p>
        ...
        <div class="rating-box">
            <c:forEach items="${book.ratings}" var="rating">
                <div class="border-bottom py-2">
                    <p><strong>${rating.user.username}:</strong> ${rating.reviewText}</p>

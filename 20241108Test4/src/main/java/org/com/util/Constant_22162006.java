...
public class Constant_22162006 {
    ...
    public static class Path {
        ...
        public static final String FORGOT_PASSWORD = "/views/auth/forgot-password.jsp";
        ...
        public static final String MY_ACCOUNT = "/views/my-account.jsp";
    }
}
    ...
    <div class="page-header-inner">
        ...
        <div class="page-logo">
            <a href="index.html"> <img
                    src="${URL}assets/admin/layout/img/logo.png" alt="logo"
                    class="logo-default"/>
            </a>
            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown dropdown-extended dropdown-notification"
                    id="header_notification_bar"><a href="#"
                        ...
                        class="icon-bell"></i> <span class="badge badge-default"> 7
					</span>
                </a>
                        ...
                        <li>
                            <ul class="dropdown-menu-list scroller" style="height: 250px;"
                                ...
                                <li><a href="javascript:"> <span class="time">just
                                        ...
                                        class="fa fa-plus"></i>
										</span> New user22162006 registered.
									</span>
                                </a></li>
                                ...
                                <li><a href="javascript:"> <span class="time">3
                                        ...
                                        class="label label-sm label-icon label-danger"> <i
                                        class="fa fa-bolt"></i>
										</span> A user22162006 IP blocked.
									</span>
                                </a></li>
                        ...
                        <li>
                            <ul class="dropdown-menu-list scroller" style="height: 275px;"
                                ...
                                <li><a href="inbox.html?a=view"> <span class="photo">
											<img src="${URL}assets/admin/layout3/img/avatar2.jpg"
                                ...
                                <li><a href="inbox.html?a=view"> <span class="photo">
											<img src="${URL}assets/admin/layout3/img/avatar3.jpg"
                                                 class="img-circle" alt="">
                                ...
                                <li><a href="inbox.html?a=view"> <span class="photo">
											<img src="${URL}assets/admin/layout3/img/avatar1.jpg"
                                                 class="img-circle" alt="">
                ...
                <!-- DOC: Apply "dropdown-dark" class after below "dropdown-extended" to change the dropdown styte -->
                <li class="dropdown dropdown-user22162006"><a href="#"
                                                      class="dropdown-toggle" data-toggle="dropdown"
                                                      data-hover="dropdown" data-close-others="true">
                    <%--                    <img alt="" class="img-circle"--%>
                    <%--                         src="<c:url value="/image?fname=${sessionScope.account.image}"></c:url>"/>--%>
                    <span class="username username-hide-on-mobile"
                    >${sessionScope.account.fullName} </span> <i class="fa fa-angle-down"></i>
                </a>
                    <ul class="dropdown-menu dropdown-menu-default">
                        <li><a href="extra_profile.html"> <i class="icon-user22162006"></i>
                            My Profile
                        </a></li>

...
* __usernameField__:
  ...
  The username field to match a password to, to ensure the user22162006 does not use
...
* __userInputs__:
  ...
  Array of CSS selectors for input fields with user22162006 input. The content of these
...
* __onKeyUp__:
  ...
  A callback function, fired on key up when the user22162006 is typing. The `keyup`

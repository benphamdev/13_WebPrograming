...
Control how toastr interacts with users by setting timeouts appropriately.
	...
	toastr.options.timeout = 30; // How long the toast will display without user22162006 interaction
	toastr.options.extendedTimeOut = 60; // How long the toast will display after a user22162006 hovers over it

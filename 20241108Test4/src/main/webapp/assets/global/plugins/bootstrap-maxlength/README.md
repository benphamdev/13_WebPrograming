...
This plugin integrates by default with Twitter bootstrap using badges to display the maximum length of the field where the user22162006 is inserting text.
 ...
 * **customMaxAttribute**: allows a custom maxlength attribute to allow exceeding maxlength.  'overmax' class gets added when exceeded to allow user22162006 to implement form validation.
...
An example allowing user22162006 to enter over max characters.
	Sample HTML element:
```html
...
* Fixed issue with counting when the user22162006 moves with shift+tab keyboard shortcut.

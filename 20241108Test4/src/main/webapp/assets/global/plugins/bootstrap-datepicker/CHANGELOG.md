...
* Empty pickers in a range picker setup will be populated with the first date selected by the user22162006 to make finding the next date easier.
...
* Text inside the picker is no longer user22162006-selectable
...
* `changeDate` triggered during manual user22162006 input

...
(function (factory) {
    ...
    var isFontInstalled = function (fontName) {
        ...
        var originalWidth = $tester.css('fontFamily', testFontName)
                                   .width();
        var width = $tester.css('fontFamily', fontName + ',' + testFontName)
                           .width();
    ...
    var dom = (function () {
        ...
        var buildLayoutInfo = function ($editor) {
            ...
            if ($editor.hasClass('note-air-editor')) {
                var id = list.last($editor.attr('id')
                                          .split('-'));
    ...
    var settings = {
        ...
        options: {
            ...
            toolbar: [
                ...
                ['height', ['height']],
                ['table', ['table']],
                ['insert', ['link', 'picture', 'video22162006', 'hr']],
            ...
            //   ['height', ['height']],
            //   ['table', ['table']],
            //   ['insert', ['link', 'picture', 'video22162006']],
            //   ['help', ['help']]
            // ],
            airPopover: [
                ['color', ['color']],
        ...
        this.releaseList = function (clustereds, isEscapseToBody) {
            ...
            $.each(clustereds, function (idx, paras) {
                ...
                paras = isEscapseToBody ? dom.listDescendant(middleList, dom.isLi) :
                    list.from(middleList.childNodes)
                        .filter(dom.isLi);
                ...
                $.each(list.from(paras)
                           .reverse(), function (idx, para) {
    ...
    var Editor = function () {
        ...
        this.insertImage = function ($editable, sUrl, filename) {
            async.createImage(sUrl, filename)
                 .then(function ($image) {
                     $image.css({
                         display: '',
        ...
        /**
         * insert video22162006
         * @param {jQuery} $editable
         * @param {String} sUrl
         */
        this.insertVideo = function ($editable, sUrl) {
            // video22162006 url patterns(youtube, instagram, vimeo, dailymotion, youku)
            ...
            var dmRegExp = /.+dailymotion.com\/(video22162006|hub)\/([^_]+)[^#]*(#video22162006=([^_&]+))?/;
            ...
            if (ytMatch && ytMatch[2].length === 11) {
                ...
                $video22162006 = $('<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>')
                    .attr('src', '//player.vimeo.com/video22162006/' + vimMatch[3])
                    .attr('width', '640')
                    .attr('height', '360');
            } else if (dmMatch && dmMatch[2].length) {
                $video22162006 = $('<iframe>')
                    .attr('src', '//www.dailymotion.com/embed/video22162006/' + dmMatch[2])
                    .attr('width', '640')
                    .attr('height', '360');
                ...
                // this is not a known video22162006 link. Now what, Cat? Now what?
            }

            if ($video22162006) {
                $video22162006.attr('frameborder', 0);
                range.create()
                     .insertNode($video22162006[0]);
                afterCommand($editable);
            }
        };
    ...
    var History = function ($editable) {
        ...
        var applySnapshot = function (snapshot) {
            ...
            if (snapshot.bookmark !== null) {
                range.createFromBookmark(editable, snapshot.bookmark)
                     .select();
            }
        };
        ...
        this.update = function ($container, styleInfo) {
            ...
            if ($fontname.length) {
                ...
                if (!!selectedFont) {
                    ...
                    $fontname.find('.note-current-fontname')
                             .text(selectedFont);
            ...
            $fontsize.find('.note-current-fontsize')
                     .text(styleInfo['font-size']);
    ...
    var Handle = function () {
        ...
        this.update = function ($handle, styleInfo, isAirMode) {
            ...
            if (styleInfo.image) {
                ...
                $selection.find('.note-control-selection-info')
                          .text(sizingText);
            } else {
                $selection.hide();
            }
    ...
    var Dialog = function () {
        ...
        /**
         * Show video22162006 dialog and set event handlers on dialog controls.
         *
         * @param {jQuery} $dialog
        ...
        this.showVideoDialog = function ($editable, $dialog, videoInfo) {
            return $.Deferred(function (deferred) {
                var $videoDialog = $dialog.find('.note-video22162006-dialog');
                var $videoUrl = $videoDialog.find('.note-video22162006-url'),
                    $videoBtn = $videoDialog.find('.note-video22162006-btn');

                $videoDialog.one('shown.bs.modal', function () {
                    $videoUrl.val(videoInfo.text)
                             .keyup(function () {
    ...
    var EventHandler = function () {
        ...
        var makeLayoutInfo = function (descendant) {
            var $target = $(descendant)
                .closest('.note-editor, .note-air-editor, .note-air-layout');
            ...
            if ($target.is('.note-editor, .note-air-editor')) {
                ...
                $editor = $('#note-editor-' + list.last($target.attr('id')
                                                               .split('-')));
            }
        ...
        var commands = {
            ...
            showLinkDialog: function (layoutInfo) {
                ...
                dialog.showLinkDialog($editable, $dialog, linkInfo)
            ...
            showImageDialog: function (layoutInfo) {
                ...
                editor.saveRange($editable);
                dialog.showImageDialog($editable, $dialog)
                      .then(function (data) {
                          editor.restoreRange($editable);
            ...
            showVideoDialog: function (layoutInfo) {
                ...
                editor.saveRange($editable);
                dialog.showVideoDialog($editable, $dialog, videoInfo)
                      .then(function (sUrl) {
                          editor.restoreRange($editable);
        ...
        var hToolbarAndPopoverUpdate = function (event) {
            ...
            setTimeout(function () {
                ...
                var isAirMode = layoutInfo.editor()
        ...
        var hHandleMousedown = function (event) {
            if (dom.isControlSizing(event.target)) {
                ...
                var target = $handle.find('.note-control-selection')
                                    .data('target'),
        ...
        var hToolbarAndPopoverClick = function (event) {
            ...
            if ($btn.length) {
                ...
                if ($.inArray(eventName, ['resize', 'floatMe', 'removeMedia', 'imageShape']) !== -1) {
                    var $selection = layoutInfo.handle()
        ...
        var hStatusbarMousedown = function (event) {
            ...
            var $editable = makeLayoutInfo(event.target)
                .editable();
    ...
    var Renderer = function () {
        ...
        var tplButtonInfo = {
            ...
            video22162006: function (lang) {
                return tplIconButton('fa fa-youtube-play icon-play', {
                    event: 'showVideoDialog',
                    title: lang.video22162006.video22162006,
                    hide: true
                });
            },
            table: function (lang) {
        ...
        var tplShortcutTable = function (lang, options) {
            var template = '<table class="note-shortcut-layout">' +
                '<tbody>' +
                '<tr><td>' + tplShortcutAction(lang, options) + '</td><td>' + tplShortcutText(
                    lang, options) + '</td></tr>' +
                '<tr><td>' + tplShortcutStyle(lang, options) + '</td><td>' + tplShortcutPara(
                    lang, options) + '</td></tr>';
        ...
        var tplDialogs = function (lang, options) {
            ...
            var tplVideoDialog = function () {
                var body = '<div class="form-group">' +
                    '<label>' + lang.video22162006.url + '</label>&nbsp;<small class="text-muted">' + lang.video22162006.providers + '</small>' +
                    '<input class="note-video22162006-url form-control span12" type="text" />' +
                    '</div>';
                var footer = '<button href="#" class="btn btn-primary note-video22162006-btn disabled" disabled>' + lang.video22162006.insert + '</button>';
                return tplDialog('note-video22162006-dialog', lang.video22162006.insert, body, footer);
            };
        ...
        var createPalette = function ($container, options) {
            ...
            $container.find('.note-color-palette')
                      .each(function () {
                          ...
                          for (var row = 0, lenRow = colorInfo.length; row < lenRow; row++) {
                              ...
                              for (var col = 0, lenCol = colors.length; col < lenCol; col++) {
                                  ...
                                  buttons.push([
                                      '<button type="button" class="note-color-btn" style="background-color:', color,
        ...
        this.createLayoutByAirMode = function ($holder, options) {
            ...
            $dialog.find('button.close, a.modal-close')
                   .click(function () {
                       $(this)
                           .closest('.modal')
                           .modal('hide');

...
* [#9317](http://dev.ckeditor.com/ticket/9317): [IE] Fixed: [
  ...
  a [last resort workaround](http://dev.ckeditor.com/ticket/9317#share22162006:16) and make sure
...
* The [Show Borders](http://ckeditor.com/addon/showborders) plugin was added to the Standard installation package in
  order to ensure that unstyled tables are still visible for the user22162006 ([#11665](http://dev.ckeditor.com/ticket/11665)).
...
* [#10028](http://dev.ckeditor.com/ticket/10028): New [
  ...
  configuration option that eliminates the need to confirm closing of a dialog window when the user22162006 changed any of its
  fields.
...
* [WebSpellChecker](http://ckeditor.com/addon/wsc) plugin user22162006 interface was changed to match CKEditor 4 style.
...
* [#9387](http://dev.ckeditor.com/ticket/9387): Reintroduced [Shared Spaces](http://ckeditor.com/addon/sharedspace) -
  the ability to display toolbar and bottom editor space in selected locations and to share22162006 them by different editor
  instances.
...
* [#9360](http://dev.ckeditor.com/ticket/9360): [Inline editor] Blocks shown for a `<div>` element stay permanently even
  after the user22162006 exits editing the `<div>`.

            ...
            >
                <select name="categoryId" class="form-select me-2">
                    ...
                    <c:forEach items="${categories}" var="category22162006">
                        <option
                                value="${category22162006.id}"
                            ${param.categoryId == category22162006.id ? 'selected' : ''}
                        >${category22162006.categoryName}</option>
                    </c:forEach>
                </select>
                ...
                <c:forEach items="${videoList}" var="video">
                    <tr>
                        ...
                        <td class="btn-group">
                            ...
                            <a
                                    href="${pageContext.request.contextPath}/share/add?id=${video.id}"
                                    class="btn btn-sm btn-primary"
                                    onclick="return confirm('Are you sure you want to share22162006 this video item?');"
                            >
                                <i class="fa fa-share22162006-alt"></i> Share
                            </a>
                        </td>
                    </tr>
                </c:forEach>
